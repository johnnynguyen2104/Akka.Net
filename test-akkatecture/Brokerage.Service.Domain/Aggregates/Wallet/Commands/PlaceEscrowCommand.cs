...
{
    public class PlaceEscrowCommand : Command<Wallet, WalletId>
    {
        ...
        public PlaceEscrowCommand(WalletId walletId, Money amount, string transactionId, string foreignTransactionId) :base(walletId)
        {
